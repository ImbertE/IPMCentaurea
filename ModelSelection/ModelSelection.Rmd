...
Seedling size distribution => Only one model
Establishment rate => Only one model


Next step => import the SelectedModels.RData in ModelSelectionReport.Rmd
...
IPM_data <- read.csv("data/donneesIPM.csv") #donnees format classique
...
Number of seedlings observed is dependant on the number of seed heads :
```{r}
...
save(Seedling_survAIC,Seedling_survBIC,Seedling_survmodAIC,Seedling_survmodBIC,
  ...
  file="ModelSelection/SelectedModels.RData"
)
