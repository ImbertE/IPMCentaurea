...
Print raw data, predicted values from models (see ModelSelection.Rmd) and make a decision for survival models (seedlings and plants)   
...
Models APlant_Survglm1 and APlant_Survglm2 => very similar
Keep model APlant_Survglm2 => easier to interpret
